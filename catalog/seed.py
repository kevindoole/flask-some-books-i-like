...
prods = [
    ...
    Product(name="Clean Code",
            ...
            description="Even bad code can function. But if code isn&rsquo;t clean, it can bring a development organization to its knees. Every year, countless hours and significant resources are lost because of poorly written code. But it doesn&rsquo;t have to be that way.",
            category=prog,
            author="Robert C. Martin",
            year=2008),
    Product(name="Extreme Programming Explained",
            subhead="Embrace Change",
            description="Whether you have a small team that is already closely aligned with your customers or a large team in a gigantic or multinational organization, you will find in these pages a wealth of ideas to challenge, inspire, and encourage you and your team members to substantially improve your software development.",
            category=prog,
            author="Robert C. Martin",
            year=2008),
    Product(name="Becoming a Better Programmer",
            subhead="A Handbook for People Who Care About Code",
            description="If you&rsquo;re passionate about programming and want to get better at it, you&rsquo;ve come to the right source. Code Craft author Pete Goodliffe presents a collection of useful techniques and approaches to the art and craft of programming that will help boost your career and your well-being.",
            category=prog,
            author="Pete Goodliffe",
            year=2014),
    Product(name="The Agile Culture",
            subhead="Leading through Trust and Ownership",
            description="""The Agile Culture gives you proven models, pragmatic tools, and handy worksheets for doing just that. Building on their experience helping hundreds of companies, three world-class experts help you align and unleash the talents of everyone in your organization. Step by step, you&rsquo;ll learn how to move toward a culture of trust, in which everyone knows, owns, and improves the results. You&rsquo;ll learn practical ways to refocus on differentiators and value, resurrect energy and innovation, deal more honestly with ambiguity and risk, and overcome resistance, no matter where it comes from. This text will help you go beyond buzzwords to transform the way you deliver software&mdash;so you can delight customers, colleagues, and executives.""",
            category=process,
            author="Pollyanna Pixton",
            year=2014),
    Product(name="Lean UX",
            subhead="Applying Lean Principles to Improve User Experience",
            description="""The Lean UX approach to interaction design is tailor-made for today&rsquo;s web-driven reality. In this insightful book, leading advocate Jeff Gothelf teaches you valuable Lean UX principles, tactics, and techniques from the ground up&mdash;how to rapidly experiment with design ideas, validate them with real users, and continually adjust your design based on what you learn.""",
            category=process,
            author="Jeff Gothelf",
            year=2013),
    ...
    Product(name="The UX Book",
            subhead="Process and Guidelines for Ensuring a Quality User "
                    "Experience",
            description="""The UX Book: Process and Guidelines for Ensuring a Quality User Experience aims to help readers learn how to create and refine interaction designs that ensure a quality user experience (UX). The book seeks to expand the concept of traditional usability to a broader notion of user experience; to provide a hands-on, practical guide to best practices and established principles in a UX lifecycle; and to describe a pragmatic process for managing the overall development effort.""",
            category=design,
    ...
    Product(name="Lipstick Traces",
            ...
            description="""This is a secret history of modern times, told by way of what conventional history tries to exclude. Lipstick Traces tells a story as disruptive and compelling as the century itself.""",
            category=music,
            author="Greil Marcus",
            year=2009),
    Product(name="Rip It Up and Start Again",
            subhead="Postpunk 1978-1984",
            description="""Rip It Up and Start Again is the first book-length exploration of the wildly adventurous music created in the years after punk. Renowned music journalist Simon Reynolds celebrates the futurist spirit of such bands as Joy Division, Gang of Four, Talking Heads, and Devo, which resulted in endless innovations in music, lyrics, performance, and style and continued into the early eighties with the video-savvy synth-pop of groups such as Human League, Depeche Mode, and Soft Cell, whose success coincided with the rise of MTV. Full of insight and anecdotes and populated by charismatic characters, Rip It Up and Start Again re-creates the idealism, urgency, and excitement of one of the most important and challenging periods in the history of popular music.""",
            category=music,
            author="Simon Reynolds",
            year=2006),
    Product(name="Psychotic Reactions and Carburetor Dung",
            subhead="Rock'N'Roll as Literature and Literature as Rock 'N'Roll",
            description="""Vintage presents the paperback edition of the wild and brilliant writings of Lester Bangs--the most outrageous and popular rock critic of the 1970s--edited and with an introduction by the reigning dean of rack critics, Greil Marcus. Advertising in Rolling Stone and other major publications.""",
            category=music,
            author="Lester Bangs",
            year=2013,
